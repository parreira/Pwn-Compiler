...
class index_node; 
class and_node; 
class apply_from_to_node; 
class next_node; 
class read_node; 
class memory_reservation_node; 
class or_node; 
class not_node; 
class assignment_node; 
class return_node; 
class decl_func_node; 
class stop_node; 
class variable_node; 
