// $Id: type_checker.h,v 1.28 2015/05/18 02:53:44 ist175814 Exp $ -*- c++ -*-
...
namespace pwn {
  ...
  public:
    ...
    inline basic_type * getBasicType(basic_type * type){
      if(type == NULL){
	return NULL;
      }
      switch(type->name()){
	case basic_type::TYPE_INT: return new basic_type(4,basic_type::TYPE_INT);
	case basic_type::TYPE_DOUBLE: return new basic_type(8,basic_type::TYPE_DOUBLE);
	case basic_type::TYPE_STRING: return new basic_type(4,basic_type::TYPE_STRING);
	case basic_type::TYPE_POINTER: return new basic_type(4,basic_type::TYPE_POINTER);
      }
      return new basic_type(4,basic_type::TYPE_ERROR);  
    }
