// $Id: basic_ast_visitor.h,v 1.19 2015/05/18 02:53:44 ist175814 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_memory_reservation_node(pwn::memory_reservation_node * const node, int lvl) = 0;
...
public:
  ...
  virtual void do_decl_var_node(pwn::decl_var_node * const node , int lvl)=0;
  virtual void do_decl_func_node(pwn::decl_func_node * const node , int lvl)=0;
  virtual void do_def_func_node(pwn::def_func_node * const node , int lvl)=0;
  virtual void do_block_node(pwn::block_node * const node , int lvl)=0;
  virtual void do_call_func_node(pwn::call_func_node * const node , int lvl)=0;
  virtual void do_variable_node(pwn::variable_node * const node , int lvl)=0;
  virtual void do_apply_from_to_node(pwn::apply_from_to_node * const node , int lvl)=0;
